...
public class CustomerController {
	...
	public List<Transaction> getTransactions(@PathVariable Integer customerId, @RequestParam String type) {
		System.out.println(customerId);
		System.out.println(type);
		return customerRepository.showTransactions(customerId, type);
	}
}
